...
export default function ProjectLayout({ auth, project, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-gray-900 dark:text-gray-100 flex flex-col">
            ...
            <header className="sticky top-0 z-30 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        {/* RBAC Example: Only renders if auth.user.role === 'manager' */}
                        {user.role === 'manager' && (
                            <button
                                type="button"
