...
import ProjectCard from '@/Components/Tenant/ProjectCard';
    ...
    return (
        <TenantLayout studioName={studio?.name || 'Studio'}>
            ...
            <div className="flex flex-col py-10 px-8 space-y-10 max-w-7xl mx-auto">
                {/* Welcome Banner */}
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-surface-elevated via-slate-900 to-indigo-950/60 border border-surface-border shadow-2xl p-8">
                ...
                <div>
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h2 className="text-xl font-bold text-text-primary">Studio Projects</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <button
                            ...
                            className="group flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-surface-border hover:border-brand bg-surface-elevated/40 hover:bg-surface-elevated/80 p-8 text-center transition-all duration-200 min-h-[14rem] focus:outline-none focus:ring-2 focus:ring-brand"
                        >
                            <div className="w-14 h-14 rounded-2xl bg-brand/10 group-hover:bg-brand group-hover:text-white text-brand flex items-center justify-center transition-all duration-200 group-hover:scale-110 shadow-md">
                                <svg
                            ...
                            <h3 className="mt-4 text-base font-bold text-text-primary group-hover:text-brand transition-colors">
                                Create New Project
                            </h3>
                            <p className="mt-1 text-xs text-text-muted max-w-[14rem]">
