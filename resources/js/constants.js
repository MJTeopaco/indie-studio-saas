export const TASK_CLASSIFICATIONS_GROUPED = [
  {
...
export const TASK_TYPE_CLASSES = {
  // 1. PURPLE Family (Planning & Architecture)
  ...
  "Algorithm Optimization & Refactoring": "bg-blue-100 text-blue-800 border border-blue-200 dark:bg-blue-500/10 dark:text-blue-300 dark:border-blue-500/20",
  "Bug Resolution & Hotfixing": "bg-blue-100 text-blue-800 border border-blue-200 dark:bg-blue-500/10 dark:text-blue-300 dark:border-blue-500/20",
  ...
  // 3. AMBER Family (AI & Data Science)
  ...
  "Algorithm Evaluation & Benchmarking": "bg-amber-100 text-amber-800 border border-amber-200 dark:bg-amber-500/10 dark:text-amber-300 dark:border-amber-500/20",
  
  // 4. GREEN Family (QA & Testing)
  ...
  // 5. TEAL Family (Hardware & Game Dev)
  "Hardware Sensor Integration": "bg-teal-100 text-teal-800 border border-teal-200 dark:bg-teal-500/10 dark:text-teal-300 dark:border-teal-500/20",
  "Game Engine Logic & Asset Integration": "bg-teal-100 text-teal-800 border border-teal-200 dark:bg-teal-500/10 dark:text-teal-300 dark:border-teal-500/20",

  // 6. ROSE Family (DevOps & Infrastructure)
